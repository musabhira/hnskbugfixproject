...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(BaseAuthUser newUser) {
    final bool authChanged = (user?.loggedIn != newUser.loggedIn) || (user?.uid != newUser.uid);
    initialUser ??= newUser;
    user = newUser;
    // Refresh the app on auth change only if auth state actually changed.
    if (notifyOnAuthChange && authChanged) {
      notifyListeners();
    }
