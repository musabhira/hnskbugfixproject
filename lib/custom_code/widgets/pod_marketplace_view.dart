    ...
    return FutureBuilder<Map<String, dynamic>?>(
      ...
      builder: (context, snapshot) {
        ...
        if (s.isLoading && s.designs.isEmpty) {
          ...
          bodyContent = NotificationListener<ScrollNotification>(
            ...
            child: CustomScrollView(
              physics: isUnlocked ? const BouncingScrollPhysics() : const NeverScrollableScrollPhysics(),
              slivers: [
        ...
        return Scaffold(
          ...
          floatingActionButton: isUnlocked ? _fab(context) : null,
          body: Stack(
            children: [
              // Main content (loaded print shop items in background)
              RefreshIndicator(
                color: const Color(0xFFFFA000),
                backgroundColor: const Color(0xFF161616),
                onRefresh: isUnlocked
