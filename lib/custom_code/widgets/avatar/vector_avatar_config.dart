...
class VectorAvatarConfig {
  ...
  static const List<({
    ...
    (species: 'armored_rhino', furColor: '#64748B', eyeColor: '#DC2626', outfitColor: '#1E293B', outfitAccent: '#EF4444', accessory: 'cool_sunglasses', auraStyle: 'electric_blue', rarityTier: 'Titan Battle Rhino'),
    ...
    (species: 'abyssal_shark', furColor: '#0284C7', eyeColor: '#00F0FF', outfitColor: '#0C4A6E', outfitAccent: '#38BDF8', accessory: 'none', auraStyle: 'electric_blue', rarityTier: 'Abyssal Megalodon'),
    ...
    (species: 'nightfang_bat', furColor: '#1E1E24', eyeColor: '#EF4444', outfitColor: '#0F172A', outfitAccent: '#DC2626', accessory: 'gold_chain', auraStyle: 'cyber_purple', rarityTier: 'Nightfang Vampire Bat'),
    ...
    (species: 'astral_rabbit', furColor: '#FFFFFF', eyeColor: '#EC4899', outfitColor: '#312E81', outfitAccent: '#F472B6', accessory: 'cool_sunglasses', auraStyle: 'electric_blue', rarityTier: 'Astral Moon Rabbit'),
    ...
    (species: 'electric_ray', furColor: '#0284C7', eyeColor: '#00F0FF', outfitColor: '#0C4A6E', outfitAccent: '#00F0FF', accessory: 'cool_sunglasses', auraStyle: 'electric_blue', rarityTier: 'Volt Manta Ray'),
    ...
    (species: 'peregrine_falcon', furColor: '#475569', eyeColor: '#FACC15', outfitColor: '#1E293B', outfitAccent: '#FDE047', accessory: 'samurai_headband', auraStyle: 'electric_blue', rarityTier: 'Supersonic Falcon'),
    ...
    (species: 'tree_viper', furColor: '#059669', eyeColor: '#EF4444', outfitColor: '#064E3B', outfitAccent: '#34D399', accessory: 'gold_chain', auraStyle: 'neon_green', rarityTier: 'Emerald Tree Viper'),
    ...
    (species: 'swordfish', furColor: '#0284C7', eyeColor: '#00F0FF', outfitColor: '#0C4A6E', outfitAccent: '#38BDF8', accessory: 'samurai_headband', auraStyle: 'electric_blue', rarityTier: 'Ocean Swordfish'),
    ...
    (species: 'shadow_manticore', furColor: '#7F1D1D', eyeColor: '#EF4444', outfitColor: '#450A0A', outfitAccent: '#DC2626', accessory: 'gold_chain', auraStyle: 'cyber_purple', rarityTier: 'Shadow Manticore'),
    ...
    (species: 'volcanic_salamander', furColor: '#DC2626', eyeColor: '#FACC15', outfitColor: '#1C1917', outfitAccent: '#F97316', accessory: 'gold_chain', auraStyle: 'sunset_orange', rarityTier: 'Volcanic Salamander'),
    ...
    (species: 'cyber_mantis', furColor: '#10B981', eyeColor: '#00F0FF', outfitColor: '#064E3B', outfitAccent: '#6EE7B7', accessory: 'samurai_headband', auraStyle: 'neon_green', rarityTier: 'Cyber Mantis'),
    ...
    (species: 'black_panther', furColor: '#18181B', eyeColor: '#A855F7', outfitColor: '#09090B', outfitAccent: '#C084FC', accessory: 'gold_chain', auraStyle: 'cyber_purple', rarityTier: 'Obsidian Black Panther'),
    (species: 'sky_thunderbird', furColor: '#1E3A8A', eyeColor: '#FACC15', outfitColor: '#172554', outfitAccent: '#FDE047', accessory: 'crown', auraStyle: 'electric_blue', rarityTier: 'Sky Thunderbird'),
    ...
    (species: 'horned_lizard', furColor: '#B45309', eyeColor: '#DC2626', outfitColor: '#292524', outfitAccent: '#F59E0B', accessory: 'gold_chain', auraStyle: 'sunset_orange', rarityTier: 'Desert Horned Lizard'),
    (species: 'angler_leviathan', furColor: '#0F172A', eyeColor: '#00F0FF', outfitColor: '#0284C7', outfitAccent: '#FACC15', accessory: 'none', auraStyle: 'electric_blue', rarityTier: 'Abyssal Angler Leviathan'),
    (species: 'mecha_wolf', furColor: '#334155', eyeColor: '#00F0FF', outfitColor: '#0F172A', outfitAccent: '#38BDF8', accessory: 'cool_sunglasses', auraStyle: 'electric_blue', rarityTier: 'Mecha Cyber Wolf Alpha'),
