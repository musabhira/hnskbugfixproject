...
final List<PocketWorldRuleItem> kPocketWorldMasterRulesList = [
  ...
  const PocketWorldRuleItem(
    ...
    titleEn: '26-Hour Presidential Police Protection',
    descEn: 'Once a home suffers a raid breach, a Police Cruiser with 2 armed officers stations outside for 26 hours. Rivals cannot raid or loot during this immunity window, granting full peace to study and rebuild.',
    translationTitle: {
      'malayalam': '26-മണിക്കൂർ പ്രസിഡൻഷ്യൽ പോലീസ് പ്രൊട്ടക്ഷൻ',
      'tamil': '26 மணிநேர காவல் துறை பாதுகாப்பு',
      'telugu': '26 గంటల పోలీసు రక్షణ కవచం',
      'kannada': '26 ಗಂಟೆಗಳ ಅಧ್ಯಕ್ಷೀಯ ಪೊಲೀಸ್ ಭದ್ರತೆ',
      'hindi': '26 घंटे की राष्ट्रपति पुलिस सुरक्षा',
    },
    translationDesc: {
      'malayalam': 'ഒരു തവണ വീട് ബ്രീച്ച് ചെയ്യപ്പെട്ടാൽ ഉടൻ പോലീസ് ജീപ്പും 2 സായുധ പോലീസുകാരും 26 മണിക്കൂർ കാവൽ നിൽക്കും. ഈ സമയത്ത് ആരും നിങ്ങളെ അറ്റാക്ക് ചെയ്യില്ല. സമാധാനമായി പഠിച്ച് വീട് പുനർനിർമ്മിക്കാം!',
      'tamil': 'வீடு தாக்கப்பட்டவுடன், 26 மணிநேரத்திற்கு காவல் துறை வாகனம் மற்றும் காவலர்கள் பாதுகாப்பு தருவர். யாரும் தாக்க முடியாது. நிம்மதியாகப் படித்து பலப்படுத்தலாம்!',
      'telugu': 'ఇల్లు దాడికి గురైన వెంటనే, 26 గంటల పాటు పోలీసు జీపు మరియు సిబ్బంది రక్షణగా ఉంటారు. ఎవరూ దాడి చేయలేరు. ప్రశాంతంగా చదువుకోవచ్చు!',
      'kannada': 'ಮನೆ ಭೇದಿಸಲ್ಪಟ್ಟಾಗ, 26 ಗಂಟೆಗಳ ಕಾಲ ಪೊಲೀಸ್ ಜೀಪ್ ಮತ್ತು ಸಶಸ್ತ್ರ ಸಿಬ್ಬಂದಿ ಭದ್ರತೆ ನೀಡುತ್ತಾರೆ. ಯಾರೂ ಆಕ್ರಮಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ. ನೆಮ್ಮದಿಯಿಂದ ಕಲಿಯಿರಿ!',
      'hindi': 'घर पर हमला होने के बाद 26 घंटे के लिए पुलिस वाहन और सशस्त्र गार्ड सुरक्षा देते हैं। इस दौरान कोई हमला नहीं कर सकता।',
    },
  ),
