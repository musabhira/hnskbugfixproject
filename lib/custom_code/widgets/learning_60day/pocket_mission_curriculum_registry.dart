...
/// 🏛️ Master Registry for Pocket World Daily Mission Curricula (Days 19–38 and beyond)
class PocketMissionCurriculumRegistry {
  ...
  static bool hasDay(int day) {
    return PocketCurriculum19To28.handles(day) || PocketCurriculum29To38.handles(day);
  }
