...
class DebitNoteModel {
  ...
  factory DebitNoteModel.fromJson(Map<String, dynamic> row) {
    ...
    return DebitNoteModel(
      ...
      voucherType: v['voucher_type']?.toString() ?? 'debitNote',
      partyName: p['party_name']?.toString() ?? 'Supplier',
...
final debitNotesProvider = FutureProvider<List<DebitNoteModel>>((ref) async {
  ...
  return data
      .map((json) => DebitNoteModel.fromJson(json))
      .where((inv) => inv.voucherType == 'debitNote')
      .toList();
});
