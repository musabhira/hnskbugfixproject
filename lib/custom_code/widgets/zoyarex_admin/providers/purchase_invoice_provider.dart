...
class PurchaseInvoiceModel {
  ...
  factory PurchaseInvoiceModel.fromJson(Map<String, dynamic> row) {
    ...
    return PurchaseInvoiceModel(
      ...
      voucherType: v['voucher_type']?.toString() ?? 'purchaseInvoice',
...
final purchaseInvoicesProvider = FutureProvider<List<PurchaseInvoiceModel>>((ref) async {
  ...
  return data
      ...
      .where((inv) => inv.voucherType == 'purchaseInvoice')
      .toList();
});
