...
class ProfileGalleryServiceLikesViewTable
    extends SupabaseTable<ProfileGalleryServiceLikesViewRow> {
  @override
  String get tableName => 'profile_gallery_service_likes_view';

  @override
  ProfileGalleryServiceLikesViewRow createRow(Map<String, dynamic> data) =>
      ProfileGalleryServiceLikesViewRow(data);
}

class ProfileGalleryServiceLikesViewRow extends SupabaseDataRow {
  ProfileGalleryServiceLikesViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProfileGalleryServiceLikesViewTable();
