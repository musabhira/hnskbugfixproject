...
import {
    Menu, X, MapPin, Mail, Phone, ShoppingBag,
                ...
                >
                        ...
                        <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl">
                            ...
                            <div className="absolute bottom-0 inset-x-0 p-8 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 px-4 py-1 bg-white/10 backdrop-blur-md rounded-full border border-white/5">
                                        <div className="w-2 h-2 rounded-full bg-[var(--accent-color)] shadow-[0_0_8px_var(--accent-color)]" />
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-white/80">Premium Modern Profile</span>
                                    </div>
                    ...
                    <div className="w-full md:w-1/2 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { label: 'Contact Me', icon: MessageCircle, action: () => window.open(`https://wa.me/${profile.phone_no}`, '_blank') },
